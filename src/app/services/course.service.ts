...
export class CourseService {
  ...
  public createOrUpdateCourse(course: Course): Promise<void> {
    if (!course.id) {
      ...
      return this.afStore.collection<Course>(CoursePath).doc(course.id).set(course);
    } else {
      // Course already exists, just update the content
      return this.afStore.collection<Course>(CoursePath).ref.doc(course.id).update(course);
    }
  }
